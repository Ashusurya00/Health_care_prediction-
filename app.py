...
# ---------------- SIDEBAR ----------------
with st.sidebar:
    st.image("https://cdn-icons-png.flaticon.com/512/2966/2966481.png", width=100)
...
if selected == "🏠 Home":
    ...
    """)
    st.image("https://cdn.dribbble.com/users/1708816/screenshots/15637256/media/5e26a9a5eeed8ee0e7ce3e7a1de13d7a.gif", width=700)
...
# ---------------- ABOUT ----------------
    ...
    **Stack:** Python | TensorFlow | Streamlit  
    """)
    st.image("https://cdn.dribbble.com/users/458522/screenshots/16291964/media/7c0aef4c93080a084187e8196a564a20.gif", width=400)
